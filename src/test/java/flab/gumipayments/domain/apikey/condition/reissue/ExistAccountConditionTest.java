...
class ExistAccountConditionTest {
    ...
    void accountExist01() {
        ReIssueCommand issueCommand = apiKeyReIssueCommandBuilder.accountExist(true).build();
        sut = EXIST_ACCOUNT;
    ...
    void accountExist02() {
        ReIssueCommand issueCommand = apiKeyReIssueCommandBuilder.accountExist(false).build();
        sut = EXIST_ACCOUNT;
