...
class ApiKeyReIssueConditionTest {
    private ApiKeyReIssueCondition alwaysTrue = command -> true;
    private ApiKeyReIssueCondition alwaysFalse = command -> false;
    private ReIssueFactor reIssueFactor = ReIssueFactor.builder().build();
